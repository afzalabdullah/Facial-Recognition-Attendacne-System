    ...
    if faces is not None:
        for box in faces:
            try:
                ...
                # Recognize face
                recognized_name, confidence = recognize_face(image.crop((x_face, y_face, x_face + w_face, y_face + h_face)))
...
image_path = './tests/test_image3.jpg'  # Path to your test image
result_frame = process_image(image_path)
